...
my_simple_corpus  <- corpus(mobydick, docid_field = "author", text_field = "doc_text")
...
kwic(md_tokenized, pattern = "whale")
```
...
quanteda.textplots::textplot_wordcloud(md_dfm, random_order = FALSE, rotation = 0.25, color = "pink") #word cloud or another way
topfeatures(md_dfm, 50)
```
