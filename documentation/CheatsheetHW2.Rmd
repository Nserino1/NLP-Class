...
df$word <- stri_replace_all_fixed(
  x = df$word,                                    
  pattern = contraction_replacements$original,   # Pattern: What to search for
  replacement = contraction_replacements$expanded,  # Replacement: What to replace it with
  vectorize_all = FALSE)                         # Apply
```
